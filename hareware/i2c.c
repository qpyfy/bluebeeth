...
{
	GPIO_WriteBit(GPIOB, GPIO_Pin_4, (BitAction)BitValue);		//根据BitValue，设置SCL引脚的电平											//延时10us，防止时序频率超过要求
}

void I2C_W_SDA(uint8_t BitValue)
{
	GPIO_WriteBit(GPIOB, GPIO_Pin_3, (BitAction)BitValue);		//根据BitValue，设置SDA引脚的电平，BitValue要实现非0即1的特性											//延时10us，防止时序频率超过要求
}
...
{
	uint8_t BitValue;
	BitValue = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_3);		//读取SDA电平											//延时10us，防止时序频率超过要求
